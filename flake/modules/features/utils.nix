              ...
              widgets = [
                {
                  ...
                  widgets = [
                    ...
                    }
                    {
                      ...
                      title = "nixpkgs";
                      search-engine =
                        "https://search.nixos.org/packages?channel=unstable&query={QUERY}";
                      new-tab = true;
                      autofocus = true;
                    }
                    {
                      ...
                      title = "nixopts";
                      search-engine =
                        "https://search.nixos.org/options?channel=unstable&query={QUERY}";
                      new-tab = true;
                      autofocus = true;
                    }
                    {
                ...
                # 使用并排显示
                {
                  ...
                  widgets = [
                    ...
                    }
                    {
                      ...
                      limit = 999999;
                      feeds =
                        [{ url = "https://theinitium.com/zh-hans/rss/"; }];
                    }
                    {
                      type = "rss";
                      title = "少数派";
