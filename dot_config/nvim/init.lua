    ...
    spec = {
        -- UI/UX
        {
            ...
            -- TERMINAL
            {
                ...
                keys = {
                    { mode = "n", "<C-t>", '<Cmd>exe v:count1 . "TermExec direction=float cmd=lazygit"<CR>', desc = "ToggleTerm" },
                    { mode = "i", "<C-t>", '<Esc><Cmd>exe v:count1 . "ToggleTerm"<CR>',                      desc = "Escape Terminal Mode" },
                },
                event = "BufReadPre",
                config = function()
        ...
        -- VISUAL UTILS TO ENHANCE EDIT
        {
            ...
            -- CLAUDE CODE
            {
                ...
                keys = {
                    { mode = "n", "<leader>Ac", "<cmd>ClaudeCode<cr>",           desc = "Toggle Claude" },
                    { mode = "n", "<leader>Af", "<cmd>ClaudeCodeFocus<cr>",      desc = "Focus Claude" },
                    { mode = "n", "<leader>Ar", "<cmd>ClaudeCode --resume<cr>",  desc = "Resume Claude" },
                    { mode = "n", "<leader>AC", "<cmd>ClaudeCode --continue<cr>", desc = "Continue Claude" },
                    { mode = "n", "<leader>Am", "<cmd>ClaudeCodeSelectModel<cr>", desc = "Select model" },
                    { mode = "n", "<leader>Ab", "<cmd>ClaudeCodeAdd %<cr>",      desc = "Add current buffer" },
                    { mode = "v", "<leader>As", "<cmd>ClaudeCodeSend<cr>",       desc = "Send selection to Claude" },
                },
                config = function()
                    -- claudecode.nvim's terminal.provider swaps in a claude-tmux pane
                    -- instead of the default snacks.nvim floating terminal.
