              ...
              # --- 左侧列 (Small)：侧重基础状态 ---
              {
                ...
                widgets = [
                  ...
                  }
                  {
                    ...
                    cache = "12h";
                    url = "https://store.steampowered.com/api/featuredcategories?cc=my";
                    template = ''
                      <ul class="list list-gap-10 collapsible-container" data-collapse-after="5">
                ...
                widgets = [
                  {
                    ...
                    widgets = [
                      ...
                      }
                      {
                        type = "search";
                        title = "github";
                        search-engine = "https://github.com/search?q={QUERY}&type=repositories";
                        new-tab = true;
                        autofocus = true;
                      }
                      {
                      ...
                      }
                      {
                        type = "search";
                        title = "biibili";
                        search-engine = "https://search.bilibili.com/all?keyword={QUERY}";
                        new-tab = true;
                        autofocus = true;
                      }
                      {
                        type = "search";
                        title = "nixpkgs";
                        search-engine = "https://search.nixos.org/packages?channel=unstable&query={QUERY}";
                        new-tab = true;
                        autofocus = true;
                      }
                      {
                        type = "search";
                        title = "nixopts";
                        search-engine = "https://search.nixos.org/options?channel=unstable&query={QUERY}";
                        new-tab = true;
                        autofocus = true;
                      }
                      {
                        type = "search";
                        title = "wordnik";
                        search-engine = "https://www.wordnik.com/words/{QUERY}";
                        new-tab = true;
                        autofocus = true;
                      }
                    ];
                        ...
                        groups = [
                          {
                            ...
                            links = [
                              ...
                              {
                                title = "SSO";
                                url = "https://www.student.auckland.ac.nz";
                              }
                              {
                                title = "Duolingo";
                  ...
                  # 使用并排显示
                  {
                    ...
                    widgets = [
                      ...
                      }
                      {
                        ...
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://www.theguardian.com/world/rss"; } ];
                      }
                      {
                        type = "rss";
                        title = "Le Monde";
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://www.lemonde.fr/en/rss/une.xml"; } ];
                      }
                      {
                        type = "rss";
                        title = "報導者";
                      ...
                      }
                      {
                        ...
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://theinitium.com/zh-hans/rss/"; } ];
                      }
                      {
                        type = "rss";
                        title = "少数派";
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://sspai.com/feed"; } ];
                      }
                      {
                        type = "rss";
                        title = "Linux.do";
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://linux.do/posts.rss"; } ];
                      }
                      {
                        type = "rss";
                        title = "Aeon.co";
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://aeon.co/feed.rss"; } ];
                      }
                      {
                        type = "rss";
                        title = "Psyche";
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://psyche.co/feed"; } ];
                      }
                      {
                        type = "rss";
                        title = "The Economist";
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://www.economist.com/rss.xml"; } ];
                      }
                      {
                        type = "rss";
                        ...
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://newleftreview.org/feed"; } ];
                      }
                      {
                        type = "rss";
                        ...
                        style = "detailed-list";
                        limit = 999999;
                        feeds = [ { url = "https://www.lrb.co.uk/rss"; } ];
                      }
                    ];
                  }
                ];
...

              {
                ...
                widgets = [
                  ...
                  }
                  {
                    ...
                    template = ''<div class="text-center"><p class="size-h3 color-highlight">{{ .JSON.String "query" }}</p><p class="size-h5 color-paragraph">{{ .JSON.String "country" }}, {{ .JSON.String "city" }}</p><p class="size-h6">{{ if .JSON.Bool "proxy" }}🔒 代理IP{{ else if .JSON.Bool "hosting" }}🏢 机房IP{{ else if .JSON.Bool "mobile" }}📱 移动网络{{ else }}🌐 普通IP{{ end }}</p></div>'';
                    cache = "10m";
                  }
                  {
                    type = "monitor";
